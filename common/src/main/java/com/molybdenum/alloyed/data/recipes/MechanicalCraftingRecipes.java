...
public class MechanicalCraftingRecipes extends CreateRecipeProvider {
    ...
    // Steel toolset
    public GeneratedRecipe STEEL_AXE = create(ModItems.STEEL_AXE::get).recipe(
        MechanicalCrafting.steelToolRecipe(Lang.AXE_PATTERN));
    public GeneratedRecipe STEEL_HOE = create(ModItems.STEEL_HOE::get).recipe(
        MechanicalCrafting.steelToolRecipe(Lang.HOE_PATTERN));
    public GeneratedRecipe STEEL_PICKAXE = create(ModItems.STEEL_PICKAXE::get).recipe(
        MechanicalCrafting.steelToolRecipe(Lang.PICKAXE_PATTERN));
    public GeneratedRecipe STEEL_SHOVEL = create(ModItems.STEEL_SHOVEL::get).recipe(
        MechanicalCrafting.steelToolRecipe(Lang.SHOVEL_PATTERN));
    public GeneratedRecipe STEEL_SWORD = create(ModItems.STEEL_SWORD::get).recipe(
        MechanicalCrafting.steelToolRecipe(Lang.SWORD_PATTERN));
