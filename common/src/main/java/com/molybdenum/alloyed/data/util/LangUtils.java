...
public class LangUtils {
    ...
    public static void correctOxidizingMetalLang(String name, String metalLang) {
        for (boolean waxed : Iterate.falseAndTrue) {
            ...
            PostRegistrationHelper.addBlockLang(waxedNamePrefix + "exposed_" + name,
                waxedLangPrefix + "Exposed " + metalLang);
            PostRegistrationHelper.addBlockLang(waxedNamePrefix + "weathered_" + name,
                waxedLangPrefix + "Weathered " + metalLang);
            PostRegistrationHelper.addBlockLang(waxedNamePrefix + "oxidized_" + name,
                waxedLangPrefix + "Oxidized " + metalLang);
        }
    }
}
