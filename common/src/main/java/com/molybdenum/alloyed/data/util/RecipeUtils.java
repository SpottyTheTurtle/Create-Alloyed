...
public class RecipeUtils {
    ...
    public static class Crafting {
        ...
        public static <T extends Block> NonNullBiConsumer<DataGenContext<Block, T>, RegistrateRecipeProvider> stairs(
            ItemLike item) {
            return (ctx, prov) -> {
        ...
        public static <T extends Block> NonNullBiConsumer<DataGenContext<Block, T>, RegistrateRecipeProvider> slab(
            ItemLike item) {
            return (ctx, prov) -> {
        ...
        public static <T extends Item> NonNullBiConsumer<DataGenContext<Item, T>, RegistrateRecipeProvider> decompactingRecipe(
            TagKey<Item> blockTag) {
            return (ctx, prov) -> {
        ...
        public static <T extends Block> NonNullBiConsumer<DataGenContext<Block, T>, RegistrateRecipeProvider> compactingRecipe(
            TagKey<Item> metalTag) {
            return (ctx, prov) -> {
        ...
        public static <T extends Item> NonNullBiConsumer<DataGenContext<Item, T>, RegistrateRecipeProvider> compactingDecompactingRecipe(
            TagKey<Item> blockTag, TagKey<Item> nuggetTag) {
            return (ctx, prov) -> {
                ShapelessRecipeBuilder.shapeless(ctx.get(), 9)
                    .requires(blockTag)
                    .unlockedBy("has_ingredient", RegistrateRecipeProvider.has(blockTag))
    ...
    public static class MechanicalCrafting {
        ...
        public static UnaryOperator<MechanicalCraftingRecipeBuilder> steelToolRecipe(String[] pattern) {
            return builder -> builder
                ...
                .key('#', Ingredient.of(
                    ModTags.Items.STEEL_INGOT)) // Always use '#' for steel ingots (no need to worry if using prebuilt lang)
                .key('/', Ingredient.of(
                    ModTags.Generic.STICK)); // Always use '/' for sticks (no need to worry if using prebuilt lang)
        }
    ...
    public static class Smithing {
        ...
        public static <T extends Item> NonNullBiConsumer<DataGenContext<Item, T>, RegistrateRecipeProvider> steelItemRecipe(
            ItemLike ironEquivalent) {
            return (ctx, prov) -> {
    ...
    public static class Stonecutting {
        ...
        public static <T extends Block> NonNullBiConsumer<DataGenContext<Block, T>, RegistrateRecipeProvider> customDefaultLang(
            TagKey<Item> source, int count, String sourceName) {
            return (ctx, prov) -> {
        ...
        public static <T extends Block> NonNullBiConsumer<DataGenContext<Block, T>, RegistrateRecipeProvider> customDefaultLang(
            ItemLike source, int count, String sourceName) {
            return (ctx, prov) -> {
                SingleItemRecipeBuilder
                    .stonecutting(Ingredient.of(source), ctx.get(), count)
                    .unlockedBy("has_ingredient", RegistrateRecipeProvider.has(source))
    ...
    public static <T extends Block> void toFunction(DataGenContext<Block, T> ctx, RegistrateRecipeProvider prov,
        NonNullBiConsumer<DataGenContext<Block, T>, RegistrateRecipeProvider> factory) {
